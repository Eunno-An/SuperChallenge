...
public class NoticeListViewAdapter extends BaseAdapter {
    ...
    private ArrayList<NoticeListItem> m_oData = null;
    private int nListCnt = 0;

    public NoticeListViewAdapter(ArrayList<NoticeListItem> _oData)
    {
        m_oData = _oData;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.activity_notice_list_item, parent, false);
        }
